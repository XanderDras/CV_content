...
% Target: SW Engineer Trainee — 5G Layer 1 Software (Amadora, Portugal)
%%%%%%%%%%%%%%%%
...
\begin{document}
    \name{Martim Silva}
    \tagline{Software Engineering Student | Real-Time Embedded C/C++ \\ Python, Testing \& CI/CD for Telecom Systems}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{SKILL STACK}
            \begin{sloppypar*}
                \cvtags{C++/true, C/true, Real-Time Systems/true, Embedded Systems/true, Python/true, Linux/true, FreeRTOS, Testing, CI/CD, Docker, Git, GDB, ContainerLab, gNMI}
                \medskip
            \end{sloppypar*}
        % ----- TECH STACK -----
        ...
        \cvsection{About Me}
            \begin{quote}
            Telecommunications and software engineering student with hands-on real-time embedded C/C++ experience on FreeRTOS-based satellite firmware and microcontroller robotics. Comfortable with Python tooling, CI/CD pipelines, and containerised workflows applied to multi-vendor telecom labs.
            \end{quote}
        % ----- ABOUT ME -----
        ...
        \cvsection{Engineering Projects}
            ...
            \begin{itemize}
                \item Developing FreeRTOS-based firmware in C/C++ for an embedded SoC with hard real-time constraints; implementing task scheduling, interrupt handling, and telemetry acquisition with downlink over 433~MHz RF.
                \item Writing hardware peripheral drivers over I2C, SPI, UART, and GPIO; building firmware with the ESP-IDF cross-compilation toolchain and validating through hardware-in-the-loop testing.
            \end{itemize}
        ...
        \cvsection{Experience}
            ...
            \begin{itemize}
                ...
                \item Designed and programmed autonomous robots in C/C++ on Arduino microcontrollers with interrupt-driven, real-time sensor-actuator control loops.
            \end{itemize}
            \divider
